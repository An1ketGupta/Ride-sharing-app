        ...
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto max-w-4xl px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-10">
                <motion.div
                    ...
                    className="relative overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg"
                >
                    <div className="p-4 sm:p-6 md:p-8">
                        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-5">
                            <div className="relative">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full ring-4 ring-gray-200 overflow-hidden bg-gray-100 flex items-center justify-center">
                                    {profilePicUrl ? (
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-2 -left-2 bg-blue-600 text-white rounded-full p-2 shadow-md hover:bg-blue-700 transition-all duration-200 z-10"
                                    disabled={uploadingPic}
                                    title="Update profile picture"
                                >
                                    <Camera className="w-4 h-4" />
                                </button>
                                <div className="absolute -bottom-2 -right-2 bg-blue-600 text-white rounded-lg px-3 py-1 text-xs font-bold shadow-md">
                                    {displayRole || 'User'}
                                </div>
                            </div>
                            <div className="flex-1 text-center sm:text-left w-full sm:w-auto">
                                <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight break-words text-gray-900">{user.name || '—'}</h1>
                                <div className="mt-2 flex flex-col sm:flex-row gap-2 sm:items-center sm:gap-4 text-xs sm:text-sm text-gray-500">
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    >
                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                            <h2 className="text-base sm:text-lg font-bold text-gray-900">Emergency Contact</h2>
                        </div>
                        ...
                        <div className="mt-4">
                            <motion.button
                                ...
                                className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-md"
                            >
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            {savedLocations.map((loc) => (
                                <div key={loc.location_id} className="flex items-center justify-between p-3 rounded-lg border border-gray-200 bg-gray-50">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 sm:gap-2 mt-4">
                                <input
                                    ...
                                    className="col-span-1 px-3 py-2 bg-white border border-gray-300 rounded-lg focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none text-xs sm:text-sm text-gray-900 placeholder:text-gray-400"
                                />
                                <div className="col-span-1 sm:col-span-2 relative flex gap-2">
                                    <div className="flex-1 relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none text-sm text-gray-900 placeholder:text-gray-400"
                                        />
                                    </div>
                                    <button
                                        type="button"
                                ...
                                <button
                                    ...
                                    className="col-span-1 sm:col-span-1 px-3 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center justify-center gap-1 text-xs sm:text-sm shadow-md"
                                >

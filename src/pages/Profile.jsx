                    ...
                    <div className="p-4 sm:p-6 md:p-8">
                        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-5">
                            <div className="relative">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full ring-4 ring-gray-800 overflow-hidden bg-gray-800 flex items-center justify-center">
                                    {profilePicUrl ? (
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-2 -left-2 bg-[#0EA5E9] text-white rounded-full p-2 shadow-md hover:bg-[#0c94d6] transition-all duration-200 z-10"
                                    disabled={uploadingPic}
                                    title="Update profile picture"
                                >
                                    <Camera className="w-4 h-4" />
                                </button>
                                <div className="absolute -bottom-2 -right-2 bg-[#0EA5E9] text-white rounded-xl px-3 py-1 text-xs font-bold shadow-md">
                                    {displayRole || 'User'}
                                </div>
                            </div>
                            <div className="flex-1 text-center sm:text-left w-full sm:w-auto">
                                <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight break-words text-white">{user.name || '—'}</h1>
                                <div className="mt-2 flex flex-col sm:flex-row gap-2 sm:items-center sm:gap-4 text-xs sm:text-sm text-gray-400">
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    >
                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                            <h2 className="text-base sm:text-lg font-bold text-white">Emergency Contact</h2>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-gray-800 border-2 border-gray-700 rounded-xl focus:border-[#0EA5E9] focus:ring-4 focus:ring-[#0EA5E9]/10 outline-none text-white placeholder:text-gray-500"
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="mt-4">
                            <motion.button
                                ...
                                className="px-4 py-2 bg-[#0EA5E9] text-white font-semibold rounded-xl hover:bg-[#0c94d6] transition-all duration-200 shadow-md"
                            >
                    ...
                    <motion.div
                        ...
                        className="rounded-xl border border-gray-800 bg-gray-900 shadow-lg p-6"
                    >
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-white">Saved Locations</h2>
                        </div>
                        <div className="space-y-3">
                            {savedLocations.map((loc) => (
                                <div key={loc.location_id} className="flex items-center justify-between p-3 rounded-xl border border-gray-800 bg-gray-800">
                                    <div className="flex items-center gap-3">
                                        <MapPin className="w-5 h-5 text-[#0EA5E9]" />
                                        <div>
                                            <p className="font-semibold text-white">{loc.name}</p>
                                            <p className="text-xs text-gray-500">{loc.lat && loc.lon ? `${loc.lat.toFixed(6)}, ${loc.lon.toFixed(6)}` : 'Coordinates not available'}</p>
                                        </div>
                                    </div>
                                    <button
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 sm:gap-2 mt-4">
                                <input
                                    ...
                                    className="col-span-1 px-3 py-2 bg-gray-800 border-2 border-gray-700 rounded-xl focus:border-[#0EA5E9] outline-none text-xs sm:text-sm text-white placeholder:text-gray-500"
                                />
                                <div className="col-span-1 sm:col-span-2 relative flex gap-2">
                                    <div className="flex-1 relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2 bg-gray-800 border-2 border-gray-700 rounded-xl focus:border-[#0EA5E9] outline-none text-sm text-white placeholder:text-gray-500"
                                        />
                                    </div>
                                    <button
                                        type="button"
                                        ...
                                        className="px-3 py-2 bg-[#0EA5E9] text-white rounded-xl hover:bg-[#0c94d6] transition-all duration-200 flex items-center justify-center"
                                ...
                                <button
                                    ...
                                    className="col-span-1 sm:col-span-1 px-3 py-2 bg-[#0EA5E9] text-white rounded-xl font-semibold hover:bg-[#0c94d6] transition-all duration-200 flex items-center justify-center gap-1 text-xs sm:text-sm shadow-md"
                                >
